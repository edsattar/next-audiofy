...
import { AiFillStepBackward as PlayPreviousIcon, AiFillStepForward as PlayNextIcon } from "react-icons/ai";
  ...
  return (
    <div className="grid h-full grid-cols-2 md:grid-cols-3">
      ...
      <div className="hidden h-full w-full max-w-[722px] items-center justify-center gap-x-6 md:flex">
        ...
        <div
          onClick={handlePlay}
          className="flex cursor-pointer items-center justify-center rounded-full bg-white p-1"
        >
          <PlayPauseIcon size={30} className="text-black p-0.5" />
        </div>
        <PlayNextIcon
          onClick={onPlayNext}
          size={30}
